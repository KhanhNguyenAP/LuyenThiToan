...
app.controller('AppCtrl', function($scope) {
    $scope.algebra = [
        { name: 'Khảo sát hàm số', img: 'images/icons/algebra_graph.png', url:'views/graph.html' },
    ...
    $scope.hinhhoc = [
        { name: 'Tính khoảng cách', img: 'images/icons/hh_lenght.png', url:'views/length.html' }
    ];
