...
public class Flags {
    ...
    public static int chosen_luyenthi = 0;

    public static String chosen_ma_kienthuc = Def.STRING_EMPTY;
    public static String chosen_ma_dethi = Def.STRING_EMPTY;
    public static String chosen_ma_baihoc = Def.STRING_EMPTY;
    public static String chapterId = Def.STRING_EMPTY;
